...
public class  EvaluateDao {
	...
	public int addEvaluate(Evaluate evaluate, Connection conn){
		String sql = "INSERT INTO evaluate(evaluate_id,evaluate_year,evaluate_year_half,teacher_id,student_id,quality_score,post_score,skill_score,coach_score) values(null,?,?,?,?,?,?,?,?)";
	...
	public int updateEvaluate(Evaluate evaluate, Connection conn){
		...
		if(evaluate.getQuality_score()!=0){
			sBuilder.append(", quality_score = " + evaluate.getQuality_score() +" ");
		}
		if(evaluate.getPost_score()!=0){
			sBuilder.append(", post_score = " + evaluate.getPost_score() +" ");
		}
		if(evaluate.getSkill_score()!=0){
			sBuilder.append(", skill_score = " + evaluate.getSkill_score() +" ");
		}
		if(evaluate.getCoach_score()!=0){
			sBuilder.append(", coach_score = " + evaluate.getCoach_score() +" ");
		}
