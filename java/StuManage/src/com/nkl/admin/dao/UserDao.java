...
public class  UserDao {
	...
	public int addUser(User user, Connection conn){
		String sql = "INSERT INTO user(user_id,user_name,user_pass,real_name,user_sex,user_age,clazz_id,reg_date,user_type,user_question,user_answer,note) values(null,?,?,?,?,?,?,?,?,?,?,?)";
